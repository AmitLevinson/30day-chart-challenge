...
ggplot(data = pictograms, aes(x =x, y= y, color = factor(has_rstats))) +
  ...
  labs(
    ...
    subtitle  = "My tweets over the years, comparing those with the #rstats hashtag to those without. Overall I used\nthe hashtag 140 times, for a total of ~38% out of all tweets and quote tweets since 2019 (n = 364).\nReplies and retweets are excluded. ",
    x = NULL,
     y= NULL,
...
ggsave("02.png", width = 8, height = 5)  
